...
class SecureConfig:
    ...
    def validate_config(self) -> Dict[str, bool]:
        ...
        bitvavo_valid = (
            "bitvavo" in config and 
            config["bitvavo"].get("api_key") and 
            config["bitvavo"].get("api_secret")
        )
        
        return {
            "valid": bitvavo_valid,  # Bitvavo is required
            "bitvavo": bitvavo_valid
        }
...
def setup_initial_config():
    ...
    # Store configuration
    config.set_api_keys(
        bitvavo_key=bitvavo_key,
        bitvavo_secret=bitvavo_secret
    )
