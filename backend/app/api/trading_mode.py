...
from app.services.trading_mode import trading_mode_service, TradingMode
...
async def get_trading_mode_status():
    ...
    try:
        can_trade_live, validation_message = trading_mode_service.validate_live_trading_requirements()
...
async def validate_live_trading():
    ...
    try:
        can_trade_live, message = trading_mode_service.validate_live_trading_requirements()
        
        # Create detailed breakdown
        details = {
            "api_key_configured": bool(trading_mode_service.current_mode),  # Simplified check
