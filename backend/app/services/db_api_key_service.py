...
class DatabaseAPIKeyService:
    ...
    def get_bitvavo_credentials(self, db: Session = None) -> Tuple[Optional[str], Optional[str]]:
        ...
        try:
            ...
            api_secret = self.encryption_service.decrypt(api_key_record.encrypted_api_secret)
    ...
    def get_exchange_credentials(self, exchange: str, db: Session = None) -> Tuple[Optional[str], Optional[str]]:
