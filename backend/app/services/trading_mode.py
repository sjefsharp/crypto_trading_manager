...
class TradingModeService:
    ...
    def set_mode(self, mode: TradingMode, force_dry_run: bool = False):
        ...
        logger.info(f"Trading mode set to: {mode.value}, dry_run: {self.dry_run_enabled}")
    ...
    def simulate_order_response(self, order_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        logger.info(f"[{self.current_mode.value.upper()}] Simulated order: {order_id} - {order_data}")
