...
def validate_order_size(market: str, amount: float) -> Dict[str, Any]:
    ...
    min_sizes = {"BTC-EUR": 0.001, "ETH-EUR": 0.01, "ADA-EUR": 1.0, "DOT-EUR": 0.1}
...
def generate_stop_loss_order(
    main_order: Dict[str, Any], stop_loss_percentage: float
) -> Dict[str, Any]:
...
def generate_take_profit_order(
    main_order: Dict[str, Any], take_profit_percentage: float
) -> Dict[str, Any]:
