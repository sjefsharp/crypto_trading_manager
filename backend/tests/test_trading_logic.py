...
class TestPortfolioOperations:
    ...
    def test_update_portfolio_positions(self):
        ...
        # Mock new trade
        new_trade = {"symbol": "BTC", "side": "buy", "amount": 0.05, "price": 45000.0}
        ...
        assert (
            abs(btc_position["amount"] - 0.15) < 1e-10
    ...
    def test_rebalance_portfolio_suggestions(self):
        ...
        target_allocation = {"BTC": 0.5, "ETH": 0.3, "ADA": 0.2}  # 50%  # 30%  # 20%
...
class TestTradingLogic:
    ...
    def test_calculate_order_fees(self):
        ...
        order = {"market": "BTC-EUR", "side": "buy", "amount": 0.1, "price": 45000.0}
    ...
    def test_check_sufficient_balance(self):
        ...
        order = {"market": "BTC-EUR", "side": "buy", "amount": 0.001, "price": 45000.0}
    ...
    def test_calculate_stop_loss_order(self):
        ...
        stop_loss_order = generate_stop_loss_order(
            main_order, stop_loss_percentage=0.05
        )
    ...
    def test_calculate_take_profit_order(self):
        ...
        take_profit_order = generate_take_profit_order(
            main_order, take_profit_percentage=0.10
        )
        ...
        assert (
            abs(take_profit_order["price"] - 49500.0) < 0.01
        )  # 10% above 45000 with tolerance
...
class TestMarketDataProcessing:
    ...
    def test_calculate_price_change(self):
        ...
        assert change_data["percentage_change"] == pytest.approx(
            4.65, rel=1e-2
        )  # 2000/43000 * 100
    ...
    def test_detect_price_alerts(self):
        ...
        alerts = [
            ...
            },
            {
                ...
                "price": 44000.0,
                "active": True,
            },  # Set to same price so only "above" triggers
        ]
...
class TestRiskManagement:
    ...
    def test_calculate_position_risk(self):
        ...
        risk_metrics = calculate_position_risk(
            position, portfolio_value, portfolio_balance
        )
    ...
    def test_validate_order_risk(self):
        ...
        portfolio_value = 10000.0
        risk_limits = {"max_position_size_percentage": 20.0, "max_order_value": 5000.0}
