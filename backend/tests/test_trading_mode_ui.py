...
class TestTradingModeUIIntegration:
    ...
    def test_ui_friendly_error_responses(self):
        ...
        assert isinstance(error_data["detail"], str)  # UI kan string messages verwachten
    ...
    def test_mode_switching_workflow_for_ui(self):
        ...
        response = self.client.post("/api/v1/trading-mode/set", json={
            "mode": "demo",
            "force_dry_run": False
        })
        assert response.status_code == 200
    ...
    def test_emergency_dry_run_for_ui(self):
        ...
        self.client.post("/api/v1/trading-mode/set", json={
            "mode": "demo",
            "force_dry_run": False
        })
    ...
    def test_response_format_consistency_for_ui(self):
        ...
        required_status_fields = [
            "current_mode", "dry_run_enabled", "is_live_trading", "warning_message"
        ]
