...
class TestTradingAPI:
    ...
    @patch.dict('os.environ', {'BITVAVO_API_KEY': 'test_key', 'BITVAVO_API_SECRET': 'test_secret'})
    ...
    @patch('app.services.bitvavo_api_secure.BitvavoAPI.get_balance')
    def test_get_balance_with_configured_keys(self, mock_get_balance, client, mock_bitvavo_response):
    ...
    def test_place_order_success(self, mock_place_order, mock_get_db, client, mock_bitvavo_response, sample_order_data):
    ...
    @patch('app.api.trading.get_db')
    @patch('app.services.bitvavo_api_secure.BitvavoAPI.place_order')
    def test_place_order_with_stop_loss(self, mock_place_order, mock_get_db, client, mock_bitvavo_response):
    ...
    def test_cancel_order(self, mock_cancel_order, client):
        ...
        mock_cancel_order.return_value = {"orderId": "test-order-123", "status": "cancelled"}
