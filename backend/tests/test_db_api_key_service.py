...
class TestDatabaseAPIKeyService:
    ...
    def test_get_credentials_multiple_exchanges(self, mock_get_encryption):
        ...
        for exchange in exchanges:
            ...
            # Test
            api_key, api_secret = service.get_exchange_credentials(exchange, self.mock_db)
    ...
    def test_invalid_parameters(self):
        ...
        assert api_key is None and api_secret is None or isinstance(api_key, (str, type(None)))
